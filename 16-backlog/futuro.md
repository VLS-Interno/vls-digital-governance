...
| F12 / F13 / F14 *(corrigido 01/09 — auditoria de fechamento achou que essas 3 linhas tinham sido removidas da Seção 8 sem destino)* | Heurística de cidade por texto; boilerplate de acesso a banco; `lead_sessions` lido fora do bounded context | Mesmo grupo de F10/F11/F15 — decisão de arquitetura já registrada, sem execução | 31/07/2026 | Retomada do Review Pipeline "Onda 2" |
